...
def app():
    ...
    # random 25 from high popularity
    high_tier =  random.sample(popularity_list[:200], k=25)
    # random 25 of mid popular
    mid_tier = random.sample(popularity_list[200:2000], k=25)
    # random 25 of the least popular
